...
from MISLAND.gui.DlgDownload import Ui_DlgDownload
...
class DlgDownload(DlgCalculateBase, Ui_DlgDownload):
    ...
    def update_data_table(self):
        ...
        self.data_view.horizontalHeader().setSectionResizeMode(QtWidgets.QHeaderView.ResizeToContents)
    ...
    def btn_calculate(self):
        ...
        for row in rows:
            ...
            if resp:
                mb.pushMessage(QtWidgets.QApplication.translate("MISLAND", "Success"),
                               QtWidgets.QApplication.translate("MISLAND", "Download request submitted to Google Earth Engine."),
                               level=0, duration=5)
            else:
                mb.pushMessage(QtWidgets.QApplication.translate("MISLAND", "Error"),
                               QtWidgets.QApplication.translate("MISLAND", "Unable to submit download request to Google Earth Engine."),
                               level=0, duration=5)
